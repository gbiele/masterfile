...
get_ADHD_PAPA = function() {
  ADHDdata = read_sav("savs/PAPA_K3.sav")
  #*# OLD #*# by Guido
  ...
  ADHDdata[,c("Hypsympt", "Impsympt","AttSympt",
              "Hyp_imp_sympt", "ADHDsympt", "ADHD_klin", "ADHD_Group")] <- data.frame(HypSympt, ImpSympt, AttSympt,
                      HypImpSympt, ADHDsympt, ADHDclin, ADHD_Group)
