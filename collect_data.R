...
save_dir = "F:/Forskningsprosjekter/PDB 2565 - Development  of ADHD_/Forskningsfiler/MoBa_v12_PDB2565/Data/ADHD"

data_dir = paste0(save_dir,"ADHD_3years/")
...
#####################################################
age = NaN2NA(data.table(read_sav(paste0(save_dir,"PDB1717_AlderKlinikk.sav")))[,c(index_vars,"Kontroll_Alder"),with = F])
age = merge(age,NaN2NA(data.table(read_sav(paste0(save_dir,"PDB1717_MFR_410_v8.sav"))))[,c(index_vars,"KJONN"),with = F],by = index_vars,all.y = F)
